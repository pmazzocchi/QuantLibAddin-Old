...
#if OBJHANDLER_HEX_VERSION < 0x012000f0
...
//! version string
#ifdef _DEBUG
    #define QLADDIN_VERSION "1.20.0-debug"
#else
    #define QLADDIN_VERSION "1.20.0"
#endif

//! version hexadecimal number
#define QLADDIN_HEX_VERSION 0x012000f0
//! version string for output lib name
#define QLADDIN_LIB_VERSION "1_20_0"
