...
#if OBJHANDLER_HEX_VERSION < 0x012100f0
    #error using an old version of ObjectHandler, please update.
#endif

#include <ql/version.hpp>
#if QL_HEX_VERSION < 0x012100f0
    #error using an old version of QuantLib, please update.
#endif

//! version string
#ifdef _DEBUG
    #define QLADDIN_VERSION "1.21.0-debug"
#else
    #define QLADDIN_VERSION "1.21.0"
#endif

//! version hexadecimal number
#define QLADDIN_HEX_VERSION 0x012100f0
//! version string for output lib name
#define QLADDIN_LIB_VERSION "1_21_0"
